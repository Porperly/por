...
// คำค้นหา (คีย์เวิร์ด) จากฟอร์มค้นหา
...
<body>
    <div class="navbar">
        <div class="logo">
            <img alt="travel shop" src="https://th.bing.com/th/id/OIP.sQI-YjXIpSQIQP-5oIoYCwHaJH?rs=1&pid=ImgDetMain" />
        </div>
        ...
        <div class="right-section">
            <?php if (isset($_SESSION['username'])): ?>
                <span>ยินดีต้อนรับ,
                    <a href="showdata.php?username=<?php echo urlencode($_SESSION['username']); ?>">
